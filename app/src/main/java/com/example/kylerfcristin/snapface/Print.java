...
public class Print {
    ...
    public static void i(String tag, Object... objects) {
        if(mIsDebugMode) android.util.Log.i(tag, join(objects));
    }
    public static void e(String tag, Throwable throwable, Object... objects) {
        if(mIsDebugMode)
            android.util.Log.e(tag, join(objects), throwable);
        else if(mCrashReporter != null)
            mCrashReporter.logException(new Exception(join(objects), throwable));
    }
    public static void e(String tag, Object... objects) {
        if(mIsDebugMode)
            android.util.Log.e(tag, join(objects));
        else if(mCrashReporter != null)
            mCrashReporter.logException(new Exception(join(objects)));
    }
    public static void d(String tag, Object... objects) {
        if(mIsDebugMode)android.util.Log.d(tag, join(objects));
    }
    public static void v(String tag, Object... objects) {
        if(mIsDebugMode) android.util.Log.v(tag, join(objects));
    }
    public static void w(String tag, Object... objects) {
        if(mIsDebugMode) android.util.Log.w(tag, join(objects));
    }
